...
public class AdicionarEstudanteRequestValidator : AbstractValidator<AdicionarEstudanteViewModel>
{
    public AdicionarEstudanteRequestValidator(IEstudanteRepository estudanteRepository)
    {
